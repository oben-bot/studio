...
const IdentifyOpportunitiesInputSchema = z.object({
  ecommerceData: z.string().describe('Data scraped from e-commerce sites, such as Mercado Libre and Amazon MX.'),
});
...
const OpportunitySchema = z.object({
  ...
  platform: z.string().describe('The e-commerce platform where the opportunity exists (e.g., Mercado Libre, Amazon MX).'),
...
const identifyOpportunitiesPrompt = ai.definePrompt({
  ...
  Analyze the following e-commerce data and identify potential opportunities, such as coupons or pricing errors. Return a list of opportunities including title, platform, expiry, estimatedMargin, action and details for each opportunity.
